...
setLocation(x, y);
    ...
    private void setIcon() {
       ...
       setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("GLOBAL.JPG"))); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/reception/login.png"))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/reception/delete.png"))); // NOI18N
    ...
    private void userKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_userKeyPressed
        ...
        //        if(user.getText().trim().isEmpty() && pass.getText().trim().isEmpty()){
            ...
            //        lbl3.setText("Password is Empty");
            //
            //        }
        ...
        if(user.getText().trim().isEmpty() && pass.getText().trim().isEmpty()){
            ...
            try{
                ...
                java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/stok", "root", "");
